...
<div class="ux-form">
  <ul class="ui-form">
    [registration]
      ...
      <li>
        <input placeholder="Your e-mail" type="email" name="email" id="email" class="f_input f_email">
      </li>
      [question]
      <li>
    ...
    [/registration]
    [validation]
    <li><input placeholder="Your name" type="text" id="fullname" name="fullname" class="f_input f_wide"></li>
