  ...
  <div class="ux-form">
    ...
    <ul class="ui-form">
      ...
      <li><textarea name="allowed_ip" rows="2" class="f_textarea f_wide">{allowed-ip}</textarea><br />
        Your IP: <p>{ip}</b><br /><div style="color:red;font-size:11px;">* Warning! Be careful when changing this setting.
      ...
      <li><textarea placeholder="Signature" name="signature" rows="2" class="f_textarea f_wide">{editsignatura}</textarea></li>
    </ul>
