  ...
  <div class="wrp">
    ...
    <div class="story_cont grid_3_4">
      ...
      <div class="text share-content">
        {full-story}
        {pages}
        [edit-date]<p class="editdate grey">News article is edited by: <b>{editor}</b> - {edit-date}<br>[edit-reason]Reason: {edit-reason}[/edit-reason]</p>[/edit-date]
      </div>
    </div>
  </div>
...
<div class="fullstory_foot shadow">
  <div class="wrp">
    [related-news]
    <div class="block col-news">
      <div class="block_title"><h4 class="ultrabold">Related News</h4></div>
      <div class="grid_list">{related-news}</div>
    </div>
    [/related-news]
...
<div class="block comments shadow">
  <div class="wrp">
    ...
    <div class="com_list">{comments}</div>
  </div>
</div>
{navigation}
