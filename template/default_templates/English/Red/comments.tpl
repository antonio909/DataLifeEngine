  ...
  <div class="grid_1_4">
    [rating]
      <div class="rate">
        ...
        [/rating-type-2]
        [rating-type-3]
          <div class="rate_like-deslike">
            <div class="rate_like-deslike_in">
  ...
  <div class="com_content">
    ...
    <div class="com_tools">
      [not-group=5]
        ...
        <span class="edit_btn" title="Edit">[com-edit]<i></i>[/com-edit]</span>
      [/not-group]
      <div class="com_tools_links grey">
        [fast]<svg class="icon icon-meta_reply"><use xlink:href="#icon-meta_reply"></use></svg><span>Quote</span>[/fast]
        [treecomments][reply]<svg class="icon-meta_reply"><use xlink:href="#icon-meta_reply"></use></svg><span>Reply</span>[/reply][/treecomments]
